...
const EventCard = (props) => {
  return (
    <div
      id={props.title}
      className="my-2 flex flex-col lg:flex-row justify-center items-center lg:h-[90vh] w-full border-y-2 border-lightSecondary"
    >
      ...
      <div className="lg:w-1/2 flex justify-center flex-col h-full p-4 lg:p-10">
        ...
        <button
          className="rounded-[4px] bg-blue-500 mt-5 text-lightPrimary py-2 font-bold text-xl hover:bg-[#20CD8D] focus:ring-4 focus:outline-none focus:ring-blue-200 sm:w-auto px-5 text-center mx-auto"
          style={{
            width: "fit-content",
          }}
        >
